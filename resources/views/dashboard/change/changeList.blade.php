                                ...
                                <tbody>
                                    @foreach ($datas as $data)
                                        <tr>
                                            ...
                                            <td><a href="{{ url('/crawl/' . $data->email_old_id ) }}">{{ strtolower(DB::table('etsy_accounts')->find($data->email_old_id)->email_old)}} {{ DB::table('etsy_accounts')->find($data->email_old_id)->etsy_password_old}}</a></td>
